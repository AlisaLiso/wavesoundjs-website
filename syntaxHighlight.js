function syntaxHighlight(element, mode) {
  ...
  let elemText = elementObj.innerHTML;
  let tagcolor = "#da0079";
  let tagnamecolor = "#da0079";
  let attributecolor = "#3600d6";
  let attributevaluecolor = "#78909C";
  ...
  let jsnumbercolor = "#FFD600";
  let jspropertycolor = "black";

  if (lang == "html") { elemText = htmlMode(elemText); }
  if (lang == "css") { elemText = cssMode(elemText); }
  if (lang == "js") { elemText = jsMode(elemText); }
  elementObj.innerHTML = elemText;
